sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblesson/LK6/app", ".html");
		...
		return Opa5.extend("zjblesson.LK6.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblesson/LK6/localService/mockserver"], function (mockserver) {
